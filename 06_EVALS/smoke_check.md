...
```text
Using this pack, identify the first safe verification step for give AI coding hosts a sandbox-first codebase memory setup with install checks, indexing boundaries, evidence receipts, and recovery paths.

...
Use this pack to help an AI coding agent work with `DeusData/codebase-memory-mcp` safely and verifiably.

## When To Use

- The user wants `give AI coding hosts a sandbox-first codebase memory setup with install checks, indexing boundaries, evidence receipts, and recovery paths`.

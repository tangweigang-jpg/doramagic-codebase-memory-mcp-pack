# codebase-memory-mcp Doramagic Pack for AI Coding Agents

Pack version: `v1.0.0` · Last updated: `2026-07-11`

[![Pack v1.0.0](https://img.shields.io/badge/pack-v1.0.0-blue)](./CHANGELOG.md)
[![License](https://img.shields.io/github/license/tangweigang-jpg/doramagic-codebase-memory-mcp-pack)](./LICENSE)
[![Issues](https://img.shields.io/github/issues/tangweigang-jpg/doramagic-codebase-memory-mcp-pack)](https://github.com/tangweigang-jpg/doramagic-codebase-memory-mcp-pack/issues)

Languages: English | [中文](./README.zh-CN.md)

A codebase memory server should prove what it indexed before an agent treats its answer as repository context.

This is an independent AI context resource pack for DeusData/codebase-memory-mcp: host instructions, prompt preview, evals, pitfalls, and recovery rules you can load into Claude Code, Codex, Cursor, Aider, and other AI coding agents.

> This is an independent capability pack. It is not affiliated with or endorsed by DeusData/codebase-memory-mcp unless explicitly stated.
...
## DeusData/codebase-memory-mcp Pitfalls and Recovery

Start with `03_PITFALL_LOG.md` when setup, permissions, runtime behavior, or verification fails.

## Source Attribution

This project pack was assembled by [Doramagic](https://doramagic.ai) to make DeusData/codebase-memory-mcp usable as a portable AI capability asset.

- Upstream/source: https://github.com/DeusData/codebase-memory-mcp
- License: MIT
- Pack contents: prompts, host instructions, checks, guardrails, and validation notes
- Relationship: independent pack; not affiliated with or endorsed by DeusData/codebase-memory-mcp unless explicitly stated
